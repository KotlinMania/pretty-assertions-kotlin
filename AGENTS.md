...
This file is the quick-reference operating contract for pretty-assertions-kotlin. The longer
...
pretty-assertions-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`pretty_assertions`](https://crates.io/crates/pretty_assertions). Upstream Rust is the behavioral oracle while the
