...
kotlin {
    ...
    val xcf = XCFramework("PrettyAssertions")
    ...
    swiftExport {
        moduleName = "PrettyAssertions"
        flattenPackage = "io.github.kotlinmania.prettyassertions"
    }

    android {
        namespace = "io.github.kotlinmania.prettyassertions"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "pretty-assertions-kotlin", version.toString())

    pom {
        name.set("pretty-assertions-kotlin")
        description.set("Kotlin Multiplatform port of rust-pretty-assertions/rust-pretty-assertions - Overwrite `assert_eq!` and `assert_ne!` with drop-in replacements, adding colorful diffs")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/pretty-assertions-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/pretty-assertions-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/pretty-assertions-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/pretty-assertions-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assemblePrettyAssertionsXCFramework",
    "assemblePrettyAssertionsDebugXCFramework",
    "assemblePrettyAssertionsReleaseXCFramework",
    "assembleDebugIosFatFrameworkForPrettyAssertionsXCFramework",
    "assembleReleaseIosFatFrameworkForPrettyAssertionsXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForPrettyAssertionsXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForPrettyAssertionsXCFramework",
    "assembleDebugMacosFatFrameworkForPrettyAssertionsXCFramework",
    "assembleReleaseMacosFatFrameworkForPrettyAssertionsXCFramework",
    "assembleDebugTvosFatFrameworkForPrettyAssertionsXCFramework",
    "assembleReleaseTvosFatFrameworkForPrettyAssertionsXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForPrettyAssertionsXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForPrettyAssertionsXCFramework",
    "assembleDebugWatchosFatFrameworkForPrettyAssertionsXCFramework",
    "assembleReleaseWatchosFatFrameworkForPrettyAssertionsXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForPrettyAssertionsXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForPrettyAssertionsXCFramework",
