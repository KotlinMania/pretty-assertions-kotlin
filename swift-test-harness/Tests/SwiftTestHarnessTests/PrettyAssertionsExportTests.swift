...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `PrettyAssertions.swiftmodule/`
...
//      `import PrettyAssertions` above would fail at compile time.
//
//   2. The static archive `libPrettyAssertions.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "PrettyAssertions" }` and
//      `flattenPackage = "io.github.kotlinmania.prettyassertions"` configuration in
...
//      via the `PrettyAssertionsLibrary` product.
//
...
final class PrettyAssertionsExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "PrettyAssertions swift module imported cleanly")
    }
}
